...
👉 [Complete DeFi Score Explanation →](/docs/api/understand-responses/defi-score)
...
See the [complete example in the endpoint documentation →](/docs/docs/api/endpoints/risk-profile/risk-profile#example-1-whale-wallet-high-risk)
...
<div className="button-group">
  <a href="(/docs/api/understand-responses/defi-score" className="button button--primary button--lg">
    🧮 DeFi Score Deep-Dive
  </a>
  <a href="(/docs/api/understand-responses/liquidation-simulation" className="button button--secondary button--lg">
...
- **See unexpected data?** Check [error handling guide](/docs/api/guides/error-handling)
