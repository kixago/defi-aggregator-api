...
[View full endpoint documentation →](/docs/docs/api/endpoints/risk-profile)
...
### Data Freshness
  ...
  * ✅ **Real-time on-chain queries** (not indexed data)
  * ✅ Own Ethereum/Base nodes (no rate limits)
  * ✅ **30-second response cache** for performance
  * ✅ `last_updated` timestamp in every position
...
[More use case examples →](/docs/api/use-cases)
...
[Full error handling guide →](/docs/api/error-handling)
...
\<a href="(/docs/api/quickstart" className="button button--primary button--lg"\>
🚀 5-Minute Quickstart
\</a\>
\<a href="(/docs/docs/api/endpoints/risk-profile/risk-profile" className="button button--secondary button--lg"\>
📖 Full API Reference
\</a\>
\<a href="(/docs/api/understand-responses/defi-score-explained" className="button button--secondary button--lg"\>
🧮 How Scoring Works
\</a\>
\</div\>
