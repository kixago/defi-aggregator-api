...
[See complete response structure →](/docs/api/understand-responses/overview)
...
[More code examples →](/docs/api/examples/javascript)
...
[Complete field documentation →](/docs/api/understand-responses/overview)
...
[How scoring works →](/docs/api/understand-responses/defi-score)
...
[See all authentication methods →](/docs/api/authentication)
...
[Full error handling guide →](/docs/api/guides/error-handling)
...
<div className="button-group">
  ...
  <a href="(/docs/api/understand-responses/overview" className="button button--secondary button--lg">
    🔍 Response Structure
  </a>
